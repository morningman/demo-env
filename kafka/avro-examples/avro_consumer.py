#!/usr/bin/env python3
"""
Kafka Avro Consumer with Kerberos and Schema Registry
"""
...
SCHEMA_REGISTRY_AUTH = ('admin', 'admin123')

# Kafka consumer configuration with Kerberos
consumer_config = {
    'bootstrap.servers': KAFKA_BOOTSTRAP_SERVERS,
    'security.protocol': 'SASL_PLAINTEXT',
    'sasl.mechanism': 'GSSAPI',
    'sasl.kerberos.service.name': 'kafka',
    'sasl.kerberos.keytab': 'keytabs/consumer.keytab',
    'sasl.kerberos.principal': 'consumer@EXAMPLE.COM',
...
schema_registry_conf = {
    ...
    'basic.auth.user.info': f'{SCHEMA_REGISTRY_AUTH[0]}:{SCHEMA_REGISTRY_AUTH[1]}'
}
...
def main():
    print("=== Kafka Avro Consumer with Kerberos ===")
